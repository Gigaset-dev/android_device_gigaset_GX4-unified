...
public final class FileUtils {
    ...
    private static final String TAG = "SpotlightFileUtils";
    ...
    public static void writeSingleLed(int led, int value, int global_brightness) {
        writeLine(LEDManager.BASELEDPATH + "singleled", Integer.toString(led) + " " + Integer.toString(value) + " " + Integer.toString(global_brightness));
    }

    public static void writeSingleLed(int led, float value, int global_brightness) {
        writeLine(LEDManager.BASELEDPATH + "singleled", Integer.toString(led) + " " + Integer.toString(Math.round(value)) + " " + Integer.toString(global_brightness));
    }
}
