...
package com.xtended.glyph.Settings;
...
public class SettingsFragment extends PreferenceFragment implements OnPreferenceChangeListener,
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mBrightnessPreference.setMax(299);
        mBrightnessPreference.setUpdatesContinuously(true);
        mBrightnessPreference.setOnPreferenceChangeListener(this);

        mNotifsPreference = (SwitchPreference) findPreference(Constants.GLYPH_NOTIFS_ENABLE);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preferenceKey.equals(Constants.GLYPH_NOTIFS_ENABLE)) {
            SettingsManager.setGlyphNotifsEnabled(getActivity(), true);
        }
