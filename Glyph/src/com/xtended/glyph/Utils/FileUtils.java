...
public final class FileUtils {
    ...
    public static void writeSingleLed(int led, int value, int global_brightness) {
        writeLine(Constants.SINGLELEDPATH, Integer.toString(led) + " " + Integer.toString(value) + " " + Integer.toString(global_brightness));
    }

    public static void writeSingleLed(int led, float value, int global_brightness) {
        writeLine(Constants.SINGLELEDPATH, Integer.toString(led) + " " + Integer.toString(Math.round(value)) + " " + Integer.toString(global_brightness));
    }
}
